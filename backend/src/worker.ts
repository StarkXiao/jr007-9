...
import { cleanup, creditDecaySweep, purgeOriginalImages, slaSweep, staleSweep } from "./jobs";
...
const SCHEDULES: Array<{ task: SweepJobData["task"]; pattern: string; label: string }> = [
  ...
  { task: "credit-sweep", pattern: "30 3 * * *", label: "每天 03:30：信用分衰减重算" },
